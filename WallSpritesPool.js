...
WallSpritesPool.prototype.createWindows = function() {
	...
	this.addWindowSprites(6, "fico.png");
...
WallSpritesPool.prototype.createDecorations = function() {
	...
	this.addDecorationSprites(6, "fico.png");
...
WallSpritesPool.prototype.addWindowSprites = function(amount, frameId) {
	...
	{
		var sprite1 = PIXI.Sprite.fromFrame(frameId);
		var sprite2 = PIXI.Sprite.fromFrame(frameId);
		sprite2.anchor.y = 0;
